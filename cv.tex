...
\usepackage{ifthen}
\newboolean{CV} % Is it a resume or CV
\setboolean{CV}{true}
...
\begin{tabular}{rl}
    \textsc{Address:}   & Caboolture, Queensland, Australia. (Open for relocation)\\
    \textsc{Phone:}     & +61 478 686 650\\
    \textsc{Email:}     & \href{mailto:marat@sadukow.com}{marat@sadukow.com} \\
