...
\begin{tabular}{rl}
	...
	& \small\emph{Tertiary Languages} : \textsc{F\#}, \textsc{R}, \textsc{Rust}, \textsc{JavaScript}, \textsc{SQL}, \textsc{Swift}, \textsc{Assembly} \\
	Additional skills & \small GIT, MATLAB, Code Composer Studio, RTOS, {\fb \LaTeX}\setmainfont[SmallCapsFont=Fontin-SmallCaps.otf]{Fontin.otf} \\
	\& \small environments : & \small STM32CubeMX/TrueStudio, Cython, C to Python wrappers, Conda, \\
	& \small Numpy \& Pandas, PyTests, TensorFlow, CUDA \\ 
...
\end{tabular} \\[1pc]
\small Developed an in-depth understanding of Embedded Programming during designing, prototyping and testing Battery Management Board along with QUT Motorsport student volunteers during MPhil research on the Electric vehicle. Deepened the knowledge and skill obtained at university while styding and teaching the concepts working with ATMega, STM32 and TI microcontrollers with communication protocols like SPI and I2C  for internally between components on a single board and isolated CAN-buss line in between modules. Gained a practical knowledge of debugging freshly manufactured and soldered boards using oscilloscopes and logic analyzers with controllers, which do not support JTAG breakpoint debugging.% At the late stage of research moved to primarily supporting already established concepts of the volunteer's work through GitHub tools.
% IF
\ifthenelse {\boolean{CV}}
%
% THEN
